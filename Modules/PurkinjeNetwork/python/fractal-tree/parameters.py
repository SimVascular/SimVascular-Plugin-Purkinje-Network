...
class Parameters():
    ...
    Attributes:
        input_file_name (str): The input surface mesh file name.
        output_file_name (str): The output files name prefix.
    ...
    """
    def __init__(self):
        self.input_file_name = 'sphere.vtu'
        self.output_file_name = 'sphere-line'
